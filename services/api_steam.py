...
def buscar_app_id_steam(nome_jogo):
    ...
    Returns:
        int: App ID do jogo ou None se não encontrado
    """
    try:
        ...
        print(f"Erro ao buscar App ID na Steam: {e}")
        return None
...
def buscar_trailer_steam(app_id):
    ...
    Returns:
        str: URL da página do jogo na Steam com foco no vídeo ou None
    """
    try:
        ...
        # Verifica se o app_id retornou dados válidos
        ...
        # Monta a URL da página do jogo na Steam com foco nos vídeos
        ...
        print(f"Erro ao buscar trailer na Steam: {e}")
        return None
...
def obter_trailer_steam(nome_jogo):
    ...
    Returns:
        str: URL da página do jogo na Steam ou None
    """
